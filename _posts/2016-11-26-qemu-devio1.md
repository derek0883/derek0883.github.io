...
In previous post [TCG frontend](qemu-tcg1){:target="_blank"} and [TCG backend](qemu-tcg2){:target="_blank"}, I found out for x86, the "in 0xcf8" instruction will transfered by TCG.
